...
AskUserQuestion({
  questions: [{
    question: "Why is '[question topic]' not relevant to this change?",
    header: "Justify Skip",
    options: [
      { label: "Explain in chat", description: "I'll give my reasoning" },
      { label: "Actually, let me answer it", description: "You're right — I should address this" }
    ],
    multiSelect: false
  }]
})
